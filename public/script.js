...
function endGame() {
  ...
  const finalMessage = correct >= totalQuestions / 2
    ? `<div style="font-size: 2em; margin-top: 1em;">🎉 Not bad, trivia champ! 🎉</div>`
    : `<div style="font-size: 2em; margin-top: 1em;">🤔 Yikes! Better luck next time. 🤪</div>`;
